 ...
 *
 */
public class RealEarlyServerProxy implements EarlyServerProxy
{
	 ...
	 */
	public RealEarlyServerProxy(String server_host, int server_port)
	{
		this();
